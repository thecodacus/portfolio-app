...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            {socialLinks.map((link) => {
              // Use simple SVG icons for social links
              let icon;
              switch (link.icon) {
                case 'Linkedin':
                  icon = (
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors duration-300 z-20"
